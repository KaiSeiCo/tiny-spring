...
import cn.neko.springframework.beans.*;
...
import cn.neko.springframework.beans.factory.config.*;
...
public abstract class AbstractAutowireCapableBeanFactory extends AbstractBeanFactory implements AutowireCapableBeanFactory {
    ...
    /**
     * 在设置 Bean 属性之前, 允许 BeanPostProcessor 修改属性值
     * (修改 @Value @Autowired 等等, 并注入到 BeanDefinition 的 PropertyValues 中, 即注入到Bean的属性中)
     *
     * @param beanName
     * @param bean
    ...
    protected Object createBeanInstance(BeanDefinition beanDefinition, String beanName, Object... args) throws BeansException {
        ...
        instantiationContext = new InstantiationContext(new SimpleInstantiationStrategy());
